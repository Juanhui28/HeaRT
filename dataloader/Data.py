...
# TODO: add the function to generate the negative sample and the new sampler
# TODO: get the random embedding node feature
def get_data(args):
    """
    ...
    # TODO: generate the learnable embedding for dataset without feature. 

    # TODO: here we use the default fixed split, replace with the general split
