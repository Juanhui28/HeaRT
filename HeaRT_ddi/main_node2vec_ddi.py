...
def main():
    ...
    n2v_emb = torch.load('dataset/'+args.data_name+'-n2v-embedding.pt', map_location=torch.device('cpu'))
    x = n2v_emb
    ...
    for run in range(args.runs):
        ...
        for epoch in range(1, 1 + args.epochs):
            ...
            if epoch % args.eval_steps == 0:
                ...
                results_rank, score_emb= test(model, score_func, data, evaluation_edges, x, evaluator_hit, evaluator_mrr, args.test_batch_size, args.use_valedges_as_input)
